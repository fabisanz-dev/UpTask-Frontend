...
const ProyectoEditar = () => {
  ...
  const { obtenerProyecto, proyectoItem, cargando, eliminarProyecto } = useProyectos();
    ...
    <>
      <div className="flex justify-between">
        ...
        <div className="flex items-center text-gray-400 hover:text-black">
          ...
          <button className="font-bold uppercase" onClick={handleClick}>Eliminar</button>
        </div>
      </div>
